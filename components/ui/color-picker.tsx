...
export default function ColorPicker() {
    ...
    return (
        ...
        >
            <Card className="w-full max-w-md mx-auto p-8 grid gap-8 border-2 border-gray-500 rounded-xl shadow-2xl  bg-gradient-to-br from-red-300 via-orange-300 to-yellow-300">
